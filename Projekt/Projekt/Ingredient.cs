...
namespace Projekt
{
    class Ingredient
    {
        ...
        public int TasteGenerator(int min, int max) // Denna metod genererar ett värde mellan de sifforna som anges som min och max, för att kontrollera scopet som värdet ligger i. Denna metod är public för att den ska kunna användas av subklasserna.
        {
